...
//   // const getStatusColor = (account_created) => {
//   //   switch (account_created) {
//   //     case "true":
...
//   const getDeparmentColor = (department) => {
//     const colors = {
...
//   const getStatusColor = (account_created) => {
//     const colors = {
//       "true": "bg-blue-100 text-green-800",
//       "false": "bg-green-100 text-red-800",
//     };
//     return colors[account_created] || "bg-gray-100 text-gray-800";
//   };
...
//             {/* Profile Image */}
//             {/* <div className="w-16 h-16 rounded-full flex-shrink-0 overflow-hidden bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center ring-2 ring-white shadow-md">
//               {student.photo_url ? (
//                 <img
...
//                 <Badge className={`${getDeparmentColor(student.department)} font-medium`}>
//                   {student.department}
//                 </Badge>
//                 <Badge
//                   variant="outline"
...
//                 </Badge>
//                 <Badge className={`${getStatusColor(student.account_created)} font-medium`}>
  ...
  <CardContent className="p-6 flex-1 flex flex-col justify-between">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {/* Badges */}
              <div className="flex gap-2 mb-4 flex-wrap">
                <Badge className={`${getDepartmentColor(student.department)} font-medium`}>
                  {student.department}
                </Badge>
