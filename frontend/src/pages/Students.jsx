...
//   // }, [students, searchTerm, filters]); // Depend on students, searchTerm, and filters

//   // useEffect(() => {
//   //   filterStudents();
//   // }, [filterStudents]); // Re-run effect when the memoized filterStudents function changes

// const handleSubmit = async (studentData) => {
//   if (editingStudent) {
//     await Student.update(editingStudent._id, studentData); // pass MongoDB _id
//   } else {
...
// export default function StudentsPage() {
//   const [students, setStudents] = useState([]); // ✅ use array
//   const [filteredStudents, setFilteredStudents] = useState([]);
//   const [showForm, setShowForm] = useState(false);
//   const [editingStudent, setEditingStudent] = useState(null);
//   const [isLoading, setIsLoading] = useState(true);
...
//   const handleSubmit = async (studentData) => {
//     if (editingStudent) {
//       await Student.update(editingStudent._id, studentData); // ✅ use _id
//     } else {
//       await Student.create(studentData);
//     }
//     setShowForm(false);
...
//               filteredStudents.map((student) => (
//                 <StudentCard
//                   key={student._id} // ✅ use _id
//                   student={student}
//                   onEdit={() => handleEdit(student)}
//                   onDelete={() => handleDelete(student._id)} // ✅ use _id
//                 />
//               ))
//             ) : (
//               <motion.div
